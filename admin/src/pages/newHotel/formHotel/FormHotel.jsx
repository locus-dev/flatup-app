		...
		<>
			...
			<div className="bottom">
				<div className="right">
					...
					<form style={{float: "right", marginLeft: "30px"}} >
					<div className="container" >
						<div className='form-control h-20 justify-center' style={{ marginTop: "30px" }}>
						...
						<div className='items-center justify-center h-20 w-full ' style={{ marginTop: "30px" }}>
