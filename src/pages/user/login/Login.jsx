...
const Login = () => {
  ...
  function logar(){
    axios.post('http://localhost:8081/', data={"email":email,"senha":senha}).then(
      navigate('/Home')
        ...
        <div className="side-form">
          <div className="form-box">
            ...
            <div className="form-control">
              ...
              <input type="email" min={0} className="input" placeholder="Email" id="email"  value={email} onChange={e => setEmail(e.target.value)} />
            </div>
            <div className="form-control">
              <label className="lsOptionText" for="senha">Senha</label>
              <input type="password" min={0} className="input" placeholder="Senha" id="senha" value={senha} onChange={e => setSenha(e.target.value)}/>
            </div>
            <a href="/forgot" id="forgot-senha">Esqueci a senha</a>

            <button onClick={
              logar()
            } className="form-button" >Entrar</button>
